    ...
    <div class="container-fluid container-xl d-flex align-items-center justify-content-between">
      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          <li><a href="videUno.php?12" class="active">Realidad Aumentada 1</a></li>
  ...
  <main id="main">
    ...
    <div class="example-container">
      ...
      <div id="ImgScaner" class="hidden"> 
          <div class="inner">
            <img src="ARQRO/asset/video1.png"/>
            <div class="scanline"></div>
          </div>
      </div>

      <a-scene mindar-image="imageTargetSrc: ARQRO/asset/video1.mind?1; showStats: false; uiScanning: #ImgScaner;" embedded color-space="sRGB" renderer="colorManagement: true, physicallyCorrectLights" vr-mode-ui="enabled: false" device-orientation-permission-ui="enabled: false">
        
         <a-assets>
          <img id="paintandquest-preview" src="ARQRO/icons/play.png" />
          <video    id="paintandquest-video-mp4"  src="ARQRO/asset/video1.mp4" autoplay="false" loop="true" ></video>
        </a-assets>
